...
[К оглавлению](Home.md) | [Далее: архитектура и сети](02-ARCHITECTURE-AND-NETWORKING.md)
...
Полный порядок описан в [Proxy-протоколах](06-PROXY-PROTOCOLS.md), но контрольный
